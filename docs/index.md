...
The guide provides pseudo code for the SIMD intrinsics and LBT binary translation helper instructions. The SIMD code assumes that the elements of the LSX/LASX vector registers can be accessed via members of a `union`:
