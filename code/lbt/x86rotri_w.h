...
// @meta synopsis: x86rotri.w rj, imm
// @meta desc: Compute EFLAGS (CF, OF) from 32-bit ROR of rj by count. PF/AF/ZF/SF preserved. OF defined only at
