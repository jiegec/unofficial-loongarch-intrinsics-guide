...
// @meta synopsis: x86sll.d rj, rk
// @meta desc: Compute EFLAGS from 64-bit SHL (logical left) of rj by count. OF defined only at count=1.
//
...
//
{
    ...
    uint8_t carry_out = (v >> (64 - c)) & 1;
    uint64_t r = (uint64_t)(v << c);
    EFLAGS.CF = carry_out;
