...
// @meta synopsis: x86rotri.h rj, imm
// @meta desc: Compute EFLAGS (CF, OF) from 16-bit ROR of rj by count. PF/AF/ZF/SF preserved. OF defined only at
