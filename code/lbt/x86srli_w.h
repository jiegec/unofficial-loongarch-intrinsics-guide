...
// @meta synopsis: x86srli.w rj, imm
// @meta desc: Compute EFLAGS from 32-bit SHR (logical right) of rj by count. OF defined only at count=1.
//
// @reg read: GPR[rj]
