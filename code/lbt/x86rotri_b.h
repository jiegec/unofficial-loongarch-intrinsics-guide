...
// @meta synopsis: x86rotri.b rj, imm
// @meta desc: Compute EFLAGS (CF, OF) from 8-bit ROR of rj by count. PF/AF/ZF/SF preserved. OF defined only at count=1.
// CF=0 at count=0.
//
// @reg read: GPR[rj]
