...
Beyond SIMD intrinsics, this guide also documents the **LBT** (LoongArch Binary Translation) instruction set, used for emulating x86, ARM, and MIPS ISAs. See the [LBT Basics](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt_basics/index.md) page for an overview.
