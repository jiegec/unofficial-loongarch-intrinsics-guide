...
- [LBT Integer](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/integer/index.md): `addu12i`, `adc`, `sbc`, `rotr`, `rotri`, `rcr`, `rcri`
- [x86 Integer](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/x86_integer/index.md): `x86adc`, `x86add`, `x86inc`, `x86sbc`, `x86sub`, `x86dec`, `x86mul`
- [x86 Logical](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/x86_logical/index.md): `x86and`, `x86or`, `x86xor`
- [x86 Shift](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/x86_shift/index.md): `x86rcl`, `x86rcli`, `x86rcr`, `x86rcri`, `x86rotl`, `x86rotli`, `x86rotr`, `x86rotri`, `x86sll`, `x86slli`, `x86srl`, `x86srli`, `x86sra`, `x86srai`
- [x86 FPU](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/x86_fpu/index.md): `x86mftop`, `x86mttop`, `x86inctop`, `x86dectop`, `x86settm`, `x86clrtm`, `x86settag`, `fcvt.ud.d`, `fcvt.ld.d`, `fcvt.d.ld`
- [x86 Misc](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/x86_misc/index.md): `setx86j`, `setx86loope`, `setx86loopne`
- [ARM Integer](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/arm_integer/index.md): `armadd`, `armsub`, `armadc`, `armsbc`
- [ARM Logical](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/arm_logical/index.md): `armand`, `armor`, `armxor`, `armnot`
- [ARM Shift](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/arm_shift/index.md): `armsll`, `armsrl`, `armsra`, `armrotr`, `armslli`, `armsrli`, `armsrai`, `armrotri`
- [ARM Misc](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/arm_misc/index.md): `armrrx`, `armmove`, `armmov`, `setarmj`
- [LBT State Transfer](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/state/index.md): `movgr2scr`, `movscr2gr`, `x86mfflag`, `x86mtflag`, `armmfflag`, `armmtflag`
- [LBT Jump](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/jump/index.md): `jiscr0`, `jiscr1`
- [MIPS Memory](https://jia.je/unofficial-loongarch-intrinsics-guide/lbt/mips_memory/index.md): `ldl.d`, `ldl.w`, `ldr.w`, `ldr.d`, `stl.w`, `stl.d`, `str.w`, `str.d`
